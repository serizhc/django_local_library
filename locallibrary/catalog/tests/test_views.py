...
class AuthorCreateViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user.user_permissions.add(perm_add_author)
        cls.user.save()
    ...
    def test_forbidden_if_logged_in_without_permission(self):
        ...
        self.client.login(username="no_perm", password="pass12345")
        response = self.client.get(self.url)
        self.assertEqual(response.status_code, 403)
    ...
    def test_logged_in_with_permission_loads_correct_template_and_initial(self):
        ...
        self.assertContains(response, 'name="date_of_death"')
    ...
    def test_post_creates_author_and_redirects_to_detail(self):
        ...
        self.assertEqual(author.first_name, "Isaac")
